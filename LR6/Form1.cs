...
namespace LR6
{
    ...
    public partial class Form1 : Form
    {
        ...
        double lambdaOne = 10 * 3 / 6.0;
        double lambdaTwo = 15 * 3 / 6.0;
        ...
        private void Show_Click(object sender, EventArgs e)
        {
            ...
            label14.Text = model_lambda.ToString();

            label15.Text = lambdaOne.ToString();
            label14.Text = lambdaTwo.ToString();
            label10.Text = (lambdaOne + lambdaTwo).ToString();
